...
**Step 7 (2026-07-09):** legacy analytics trees removed from this repo; `make product-boundary-strict` passes. Hosted backend and ops evidence live in private **streampulse-backend** and **streampulse-ops**.
