...
| Near-term deploy | legacy-rollback-host; HTTPS + domain before production login hardening |
...
| Area | Today |
|------|-------|
| **Production runtime** | legacy-rollback-host (`legacy-rollback-host`), Caddy `:80`, build-on-VPS from rsynced repo ([bearhost-production.md](../bearhost-production.md)) |
