# Hosting topology — BearHost VPS, laptopworker, Windows PC
...
|------|------|----------------|
| **BearHost VPS** | Production ingress, scrape, corpus, backfill, hosted API | `https://api.streampulse.stream` |
