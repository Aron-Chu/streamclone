...
const recapTopEmoteCatalogLimit = 10

func (h *Handler) enrichRecapTopEmotes(ctx context.Context, recap *pulserecap.StreamRecap, storeRollups []MinuteRollup) {
	if recap == nil {
		return
	}
	...
	catalog := TopEmotesFromRollups(storeRollups, recapTopEmoteCatalogLimit)
	catalog = filterTopEmotesSevenTV(catalog)
	if h != nil {
