...
/** Placeholder shell until P4 wires the full Streamclone analytics console. */
export function AnalyticsConsole() {
  return createElement(
    'section',
    { className: 'panel', 'aria-label': 'Streamclone analytics console' },
    createElement('h1', null, 'Streamclone Analytics Console'),
    createElement('p', { className: 'muted' }, 'Analytics data is provided by the configured Streamclone backend.'),
  )
}
